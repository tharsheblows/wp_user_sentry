...
class User {
	 ...
	 */
	public function getIp() { // @phpcs:ignore
		foreach ( array( 'HTTP_CLIENT_IP', 'REMOTE_ADDR', 'HTTP_X_FORWARDED_FOR', 'HTTP_X_FORWARDED', 'HTTP_X_CLUSTER_CLIENT_IP', 'HTTP_FORWARDED_FOR', 'HTTP_FORWARDED' ) as $key ) {
	 ...
	 */
	public function getDevice( $user_agent = null ) { // @phpcs:ignore
	 ...
	 */
	public function getCountry( $ip ) { // @phpcs:ignore
	 ...
	 * @return string   Country Code
	 */
	protected function getCountryIPAPI( $ip ) { // @phpcs:ignore
	 ...
	 */
	protected function getCountryWooCommerce( $ip ) { // @phpcs:ignore
	...
	/**
	 * Adding an emoji flag? I think.
	 *
	 * @param string $code The country code.
	 * @return string|bool The updated code or false if no flag exists.
	 */
	public function emojiFlag( $code ) { // @phpcs:ignore
	 ...
	 *
	 * @param string $char The country code.
	 * @return string|bool The unicode of the flag (?) or false if the character is not in the alphabet.
	 */
	protected function enclosedUnicode( $char ) { // @phpcs:ignore
		$arr  = array(
			'a' => '1F1E6',
			'b' => '1F1E7',
			'c' => '1F1E8',
